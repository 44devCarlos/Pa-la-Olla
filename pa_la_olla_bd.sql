...
CREATE TABLE IF NOT EXISTS `receta` (
  ...
  `nombre_receta` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion_receta` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `imagen_receta` text COLLATE utf8mb4_general_ci,
  `ingrediente_principal` text COLLATE utf8mb4_general_ci,
  `alergenos_receta` text COLLATE utf8mb4_general_ci,
  `rango_tiempo` text COLLATE utf8mb4_general_ci,
  `rango_porciones` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `rango_precio` text COLLATE utf8mb4_general_ci,
